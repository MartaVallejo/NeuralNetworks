...
addpath('C:\code\HW\bbob.v15.03\matlab');  % should point to fgeneric.m etc.
datapath = 'C:\code\HW\bbob.v15.03\matlab\experiments';  % different folder for each experiment
% opt.inputFormat = 'row';
opt.algName = 'ALGORITHM_NAME';
opt.comments = 'DETAILED_INFORMATION';%'PUT MORE DETAILED INFORMATION, PARAMETER SETTINGS ETC';
...
dimensions = [2,]; %[2, 3, 5, 10, 20, 40];  % small dimensions first, for CPU reasons
